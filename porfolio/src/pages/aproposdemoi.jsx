    ...
    <div className="bg-purple-100 min-h-screen flex flex-col items-center px-10 py-20">
      ...
      <div className="flex flex-row justify-center items-start gap-12 w-full max-w-screen-xl">
        ...
        <div className="w-[48%] flex justify-center">
          <div className="border-4 border-[#B68CD1] bg-white rounded-md p-6 shadow-md flex flex-col items-center h-[750px] w-[500px]">
            <p className="text-center text-[#6546da] mb-4 text-xl">Cliquez sur le CV pour le télécharger</p>
            <a href="/CV.pdf" download>
              <img
                src="/captureCV.png"
                alt="CV"
                className="w-auto h-max hover:opacity-80 transition"
              />
            </a>
          </div>
        </div>
