...
<div className ="ecran bg-[#F7F6F8] border-8 border-[#B68CD1] rounded-lg shadow-md p-8 w-[50%] h-96 flex flex-col items-center justify-start overflow-auto">
 ...
 <div className="bg-white border-4 border-[#B68CD1] shadow-md p-4 z-10">
    ...
    <div className="clavier space-y-2">
        <div className="ligneun flex space-x-2">
            <div className="bg-white border-2 border-violet-300 rounded px-1 py-1 hover:bg-[#F0E6F7] transition text-center text-3xl text-[#6546da]">
